...
public class GameStats {
	...
	// Balance/wager variables
	private int balance = 50;
	private int balanceDifference = 0;
	private int wager = -1;
	private boolean isValidWager = false;	// if user has entered a wager
	
	// Average price variables
	private int averagePrice = 0;	// avg price of all fish caught
	private ArrayList<Integer> prices;		// all prices of items caught by player
	
	private String currentItem = "None";	// current item caught
	...
	public void cast() {
		...
		calculateAveragePrice(itemValue);
	...
	// Calculate average price of all items caught
	public void calculateAveragePrice(int newPrice) {
		prices.add(newPrice);	// add new price
		int sum = 0;
